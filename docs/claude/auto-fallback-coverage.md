...
`executable-requirements/data/*.html` fixtures (the environment may block live fetches) — and **most runs
...
The fallback-coverage gate lives in `executable-requirements/extractors/fallback/` and runs in
