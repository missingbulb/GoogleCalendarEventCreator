// Regenerates the UI snapshots (dev/requirements/ui/cases/<name>.png) from the cases in
// dev/requirements/ui/cases/*.case.js, using the same rendering as the snapshot test (each case
