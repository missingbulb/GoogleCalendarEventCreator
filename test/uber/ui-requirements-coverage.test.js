...
//       (How the PNG is rendered — the popup vs. the toolbar icon — is the CASE's
//       own `kind`, not a spec distinction; for coverage every render leaf simply
//       needs one case. See test/ui/render-snapshot.js.)
