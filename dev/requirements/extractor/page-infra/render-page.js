...
// machinery as dev/requirements/heavy/extension-load.chrome.test.js, sharing
// dev/requirements/extractor/page-infra/cdp-client.js) and returns the post-JS rendered HTML, so a JS
// single-page-app shell becomes extractable like a normal page. Only
// dev/requirements/extractor/page-infra/refresh-cache.js calls it, and only when dev/requirements/extractor/page-infra/spa-shell.js says the plain
