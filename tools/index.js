...
// the order the extraction-pipeline files are injected into the page (and
// exercised by the tests). Run it with `npm run index` after adding/removing a
// source or pipeline file.
//
