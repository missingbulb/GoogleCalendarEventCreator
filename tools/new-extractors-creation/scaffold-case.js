...
if (require.main === module) {
  ...
  const dest = path.join(__dirname, "..", "..", "executable-requirements", "extractors", "custom", `${caseName}.json`);
  ...
  console.log(`scaffold-case: wrote executable-requirements/extractors/custom/${caseName}.json`);
}
