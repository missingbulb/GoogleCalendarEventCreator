...
// The filename (`req-5.6.1`) IS the link to the requirement; the coverage gate
// reads it, and build-requirements-gallery.js embeds this image inline under
// 5.6.1 in executable-requirements/Requirements.md. This is the worked EXAMPLE of the per-leaf
