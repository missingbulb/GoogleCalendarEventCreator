// Real-Chrome smoke test for the SPA-shell render fallback (dev/requirements/infra/data/render-page.js,
...
// dev/requirements/infra/data/spa-shell.js flags. The static shell must read as "render me" and the
