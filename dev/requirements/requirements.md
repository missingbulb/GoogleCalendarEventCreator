...
The "Suggest Correction" flow that turns a missed page into first-class support. The issue-form prefill is covered by `extension-test/events-popup/source-request-view.test.js`; the automation pipeline by the auto-extractor unit tests and `.claudinite/local/packs/gcec/tasks/create-extractor/task.md`.
...
🔧 _Logic leaf — **untested here** — currently covered by `.claudinite/local/packs/gcec/tasks/create-extractor/test/triage.test.js`._ <!-- req-gallery:16.2 -->
...
🔧 _Logic leaf — **untested here** — currently covered by `.claudinite/local/packs/gcec/tasks/create-extractor/test/triage.test.js`._ <!-- req-gallery:16.3 -->
