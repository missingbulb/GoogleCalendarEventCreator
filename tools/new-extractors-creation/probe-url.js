...
// URL, fetch it the same way executable-requirements/infra/data/refresh-cache.js records pages (shared
// executable-requirements/infra/data/fetch-page.js — browser headers, retries), then decide whether the page
...
const { fetchPage } = require("../../executable-requirements/infra/data/fetch-page");
