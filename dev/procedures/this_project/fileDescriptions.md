...
| [`extraction-policy.md`](../../../extraction-policy.md) | Public "how this extension finds events" doc; mirrors the popup's inline `POLICY_EXPLANATION` copy (kept in sync by a drift-guard test) |
