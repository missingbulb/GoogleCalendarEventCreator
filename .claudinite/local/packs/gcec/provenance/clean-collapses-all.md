## 2026-06-16 · born · technical gotchas centralized (#218)
- **Source:** descriptions losing every line break, #131, #140, #141.
- **Actor:** @missingbulb (owner).
- **Mechanism:** a gotcha in the new `docs/technicalGotchas.md`, @-imported and routed to by
  "learned lessons".
- **Landed:** #218.
