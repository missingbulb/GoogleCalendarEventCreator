...
// and dev/procedures/claude/auto-extractor.md). Two same-host requests can't run the agent
...
const HEADING =
  ...
  "`dev/requirements/extractors/custom/` case per URL, then tick it off:";
