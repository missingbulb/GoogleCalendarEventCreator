...
// This catches any drift — in extraction or in how the source page is
// parsed — however small, and the array length pins down how many events were
// found (one for an ordinary page, several for a listing/series page). When a
