// Real-Chrome smoke test for the SPA-shell render fallback (executable-requirements/infra/data/render-page.js,
...
// executable-requirements/infra/data/spa-shell.js flags. The static shell must read as "render me" and the
...
const { renderPage } = require("../infra/data/render-page");
const { shouldRender, hasExtractableData } = require("../infra/data/spa-shell");
