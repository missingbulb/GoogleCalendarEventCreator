// Real-Chrome smoke test for the SPA-shell render fallback (dev/requirements/extractor/page-infra/render-page.js,
...
// dev/requirements/extractor/page-infra/spa-shell.js flags. The static shell must read as "render me" and the
...
const { renderPage } = require("../extractor/page-infra/render-page");
const { shouldRender, hasExtractableData } = require("../extractor/page-infra/spa-shell");
