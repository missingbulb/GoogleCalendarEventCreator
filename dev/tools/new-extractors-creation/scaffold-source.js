...
//
//   node dev/tools/new-extractors-creation/scaffold-source.js <event-url>
"use strict";
...
// dev/requirements/extractor/data/${caseName}.html.
//
...
(() => {
  ...
  GCal.sources.push({
    ...
    extract() {
      // TODO(agent): refine these selectors against dev/requirements/extractor/data/${caseName}.html, and
