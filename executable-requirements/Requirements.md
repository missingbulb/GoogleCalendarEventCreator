...
> has no pixels, so it's verified by `executable-requirements/ui/events-view-actions.test.js`, which
...
- `"behavior"` — a click/navigation a static image can't observe; the case carries
  ...
  `executable-requirements/ui/events-view-actions.test.js`.
...
🚩 _Behavior leaf — verified by `executable-requirements/ui/events-view-actions.test.js` (a click a snapshot can't show), not an image._ <!-- req-gallery:3.4 -->
...
🚩 _Behavior leaf — verified by `executable-requirements/ui/events-view-actions.test.js` (a click a snapshot can't show), not an image._ <!-- req-gallery:9.1 -->
...
🚩 _Behavior leaf — verified by `executable-requirements/ui/events-view-actions.test.js` (a click a snapshot can't show), not an image._ <!-- req-gallery:9.2 -->
...
🚩 _Behavior leaf — verified by `executable-requirements/ui/events-view-actions.test.js` (a click a snapshot can't show), not an image._ <!-- req-gallery:9.3 -->
