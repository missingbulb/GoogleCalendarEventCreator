...
async function init() {
  ...
  // the single source of truth shared with the tests — see tools/gen-load-order.js.
...
// with fake data by the UI snapshot tests (executable-requirements/ui/), which pass `data`, a stub
