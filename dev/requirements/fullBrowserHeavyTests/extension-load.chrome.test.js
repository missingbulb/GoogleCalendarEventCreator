...
// deterministic Node-level equivalent is extension-test/extension/extension-loads.test.js.
//
...
// The DevTools Protocol client is shared with dev/requirements/infra/data/render-page.js (issue #310);
// Node has shipped a global WebSocket since v22 (global fetch since v18).
const { connectCDP } = require("../infra/data/cdp-client");
