// seatgeek.com event pages: https://seatgeek.com/concert-tickets
//
...
// dev/requirements/extractor/data/server-fetched/seatgeek.html.
//
...
(() => {
  ...
  GCal.sources.push({
    ...
    extract() {
      // TODO(agent): refine these selectors against dev/requirements/extractor/data/server-fetched/seatgeek.html, and
