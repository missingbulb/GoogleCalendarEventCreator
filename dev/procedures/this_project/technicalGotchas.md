...
engineering practices in [engineeringPractices.md](../claude/shared/tasks/engineeringPractices.md).
...
- **Introspecting an MV3 service worker over CDP (the real-Chrome test) has three
  ...
  hang-proofing rule in [engineeringPractices.md](../claude/shared/tasks/engineeringPractices.md).)
- **A push or PR made with the Actions `GITHUB_TOKEN` does not start another
  ...
  [claude/shared/tasks/git-and-github.md](../claude/shared/tasks/git-and-github.md).
...
- **Two portable GitHub gotchas this repo relies on — large fixtures need
  ...
  [claude/shared/tasks/git-and-github.md](../claude/shared/tasks/git-and-github.md); the `<td>`
